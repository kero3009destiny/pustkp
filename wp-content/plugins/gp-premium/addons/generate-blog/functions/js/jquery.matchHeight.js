...
jQuery(document).ready( function($) { 
	...
	jQuery('.generate-columns .inside-article').matchHeight(); 
	
	var rows = $.fn.matchHeight._rows($('.generate-columns .inside-article'));
	...
	$('.generate-columns .inside-article').on('click', function(){ 
